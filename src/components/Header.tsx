...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {mobileOpen && (
        <div className="fixed inset-0 top-14 bg-[#050505] z-40 flex flex-col justify-center px-8 space-y-6 md:hidden">
          ...
          <div className="pt-8 hairline-t flex items-center justify-between text-xs font-mono text-[#B5B5B5] tracking-widest uppercase">
            <a
              href={cvUrl}
              target="_blank"
              rel="noopener noreferrer"
